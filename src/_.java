...
public class _ {
	...
	_() throws Exception {
		Object obj = callCastClass(callCastClass(this, ¤¤¤¤¤¤¤), ¤¤¤¤¤¤¤¤¤);
		Object sy = subSeq(call(getMethod(obj, 61), ¤¤¤¤¤), ¤¤, ¤¤¤¤);
		Object st = subSeq(call(getMethod(obj, ¤¤¤¤), ¤¤¤¤¤), ¤¤¤¤, ¤¤¤¤¤¤);
		Object em = subSeq(call(getMethod(obj, 60), ¤¤¤¤¤), ¤¤¤, ¤¤¤¤¤);
		Object javalang = subSeq(getName(obj), ꠸, ¤¤¤¤¤¤¤¤ | ¤¤);
		Object javaLangSystem = concat(concat(concat(javalang, sy), st), em);
		call(((Class<?>) call(Class.class, ꠸, javaLangSystem)).getFields()[¤].get(null), ¤¤¤, "Hello World");
	}
